...
export default function AdminView({ user, projects, loading, onRefresh }: AdminViewProps) {
  ...
  // Restrict access to sunilas1711@gmail.com, maintenancemasters2001@gmail.com, and deathrb12@gmail.com
  const allowedEmails = ['sunilas1711@gmail.com', 'maintenancemasters2001@gmail.com', 'deathrb12@gmail.com'];
